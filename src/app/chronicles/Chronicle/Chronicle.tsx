...
export default function Character({ ...props }) {
    ...
    return (
        <>
            <div onClick={handleCardClick} className="chronicleCard container flex items-center content-center justify-center min-h-40 max-w-36 flex-col gap-2 border border-slate-300 rounded-lg">
